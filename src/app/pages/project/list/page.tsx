          ...
          <div className="flex flex-col gap-12 mt-6">
            <div className="w-full">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2 mt-4 border border-white/10 rounded-2xl">
                <a className='p-6 hover:bg-white/10 rounded-2xl' href="https://termicons.com" target='_blank'>
                  <div className="w-full gap-3 flex flex-col">
                    <Image className='bg-white/5 rounded-lg w-[56px] h-auto p-2' src="/img/Termicons.png" alt="Company logo" width={48} height={48} />
            ...
            <div className="w-full">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2 mt-4 border border-white/10 rounded-2xl">
                <div className="w-full gap-3 flex flex-col p-6 hover:bg-white/10 rounded-2xl">
                  <Image className='bg-white/5 rounded-xl w-full h-auto' width={300} height={188} src="/project/SocialVit.jpg" alt="SocialVit" />
                ...
                <div className="w-full gap-3 flex flex-col p-6 hover:bg-white/10 rounded-2xl">
                  <Image className='bg-white/5 rounded-xl w-full h-auto' width={300} height={188} src="/project/Eduwork.jpg" alt="Eduwork" />
                ...
                <div className="w-full gap-3 flex flex-col p-6 hover:bg-white/10 rounded-2xl">
                  <Image className='bg-white/5 rounded-xl w-full h-auto' width={300} height={188} src="/project/Sinergi.jpg" alt="Sinergi" />
