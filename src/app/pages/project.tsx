    ...
    <Container>
      ...
      <div className="flex gap-4 mt-4 px-6">
        <div className="col-3 w-full gap-3 flex flex-col">
          <Image className='bg-white/5 rounded-xl' width={300} height={188} src="/project/SocialVit.jpg" alt="SocialVit" />
        ...
        <div className="col-3 w-full gap-3 flex flex-col">
          <Image className='bg-white/5 rounded-xl' width={300} height={188} src="/project/Eduwork.jpg" alt="Eduwork" />
        ...
        <div className="col-3 w-full gap-3 flex flex-col">
          <Image className='bg-white/5 rounded-xl' width={300} height={188} src="/project/Sinergi.jpg" alt="Sinergi" />
